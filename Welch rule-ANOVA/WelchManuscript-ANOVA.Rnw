...
cov_plot <- function(data, sim, which_contrast, which_test) {
  ...
  if(str_detect(which_contrast, 'Simple Effect')) {
    ylims <- c(.76, 1)
  } else {
    ylims <- c(.80, 1)
  }
...
cov_data <- mutate(no_effects, which_sim = 'No effects') %>% 
  ...
  filter(
    min_sample == 30,
    str_detect(contrast_names, 'Main|Interaction|Simple')
  )
...
## No effects
### ANOVA
cov_no_effects_B1cont_anova <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of A at B1', which_test = 'ANOVA')
cov_no_effects_B2cont_anova <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of A at B2', which_test = 'ANOVA')
cov_no_effects_A1cont_anova <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of B at A1', which_test = 'ANOVA')
cov_no_effects_A2cont_anova <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of B at A2', which_test = 'ANOVA')

### Welch
cov_no_effects_B1cont_welch <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of A at B1', which_test = "Welch's t test")
cov_no_effects_B2cont_welch <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of A at B2', which_test = "Welch's t test")
cov_no_effects_A1cont_welch <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of B at A1', which_test = "Welch's t test")
cov_no_effects_A2cont_welch <- cov_plot(cov_data, sim = 'No effects', which_contrast = 'Simple Effect of B at A2', which_test = "Welch's t test")


## Crossover
### ANOVA
cov_crossover_B1cont_anova <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of A at B1', which_test = 'ANOVA')
cov_crossover_B2cont_anova <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of A at B2', which_test = 'ANOVA')
cov_crossover_A1cont_anova <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of B at A1', which_test = 'ANOVA')
cov_crossover_A2cont_anova <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of B at A2', which_test = 'ANOVA')

### Welch
cov_crossover_B1cont_welch <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of A at B1', which_test = "Welch's t test")
cov_crossover_B2cont_welch <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of A at B2', which_test = "Welch's t test")
cov_crossover_A1cont_welch <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of B at A1', which_test = "Welch's t test")
cov_crossover_A2cont_welch <- cov_plot(cov_data, sim = 'Crossover interaction', which_contrast = 'Simple Effect of B at A2', which_test = "Welch's t test")

## Main effects and interaction
### ANOVA
cov_me_int_B1cont_anova <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of A at B1', which_test = 'ANOVA')
cov_me_int_B2cont_anova <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of A at B2', which_test = 'ANOVA')
cov_me_int_A1cont_anova <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of B at A1', which_test = 'ANOVA')
cov_me_int_A2cont_anova <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of B at A2', which_test = 'ANOVA')

### Welch
cov_me_int_B1cont_welch <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of A at B1', which_test = "Welch's t test")
cov_me_int_B2cont_welch <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of A at B2', which_test = "Welch's t test")
cov_me_int_A1cont_welch <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of B at A1', which_test = "Welch's t test")
cov_me_int_A2cont_welch <- cov_plot(cov_data, sim = 'Main effects & interaction', which_contrast = 'Simple Effect of B at A2', which_test = "Welch's t test")
@
...
no_effects_cov_se <- plot_grid(

  # first row
  cov_no_effects_B1cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_no_effects_A1cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_no_effects_B2cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_no_effects_A2cont_anova + theme(strip.background = element_blank()),

  # second row
  cov_no_effects_B1cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_no_effects_A1cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_no_effects_B2cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_no_effects_A2cont_welch +  theme(strip.background = element_blank()),
  ncol = 4
)

crossover_cov_se <- plot_grid(

  # first row
  cov_crossover_B1cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_crossover_A1cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_crossover_B2cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_crossover_A2cont_anova + theme(strip.background = element_blank()),

  # second row
  cov_crossover_B1cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_crossover_A1cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_crossover_B2cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_crossover_A2cont_welch +  theme(strip.background = element_blank()),
  ncol = 4
)

me_int_cov_se <- plot_grid(

  # first row
  cov_me_int_B1cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_me_int_A1cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_me_int_B2cont_anova + theme(strip.text.y = element_blank(), strip.background = element_blank()),
  cov_me_int_A2cont_anova + theme(strip.background = element_blank()),

  # second row
  cov_me_int_B1cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_me_int_A1cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_me_int_B2cont_welch + theme(strip.text.x = element_blank(), strip.text.y = element_blank(), strip.background = element_blank()),
  cov_me_int_A2cont_welch +  theme(strip.background = element_blank()),
  ncol = 4
)

plot_grid(
  plot_grid(
    tf_no_effects, no_effects_cov_se,
    tf_crossover, crossover_cov_se,
    tf_me_int, me_int_cov_se,
    ncol = 2, rel_widths = c(.25, .75)
  ),
  plot_grid(plot_legend),
  ncol = 2,
