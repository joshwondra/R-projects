...
First, past research has focused on research designs with two groups; we show how Welch's t test can be used to test any two degrees of freedom contrast in designs with more than two groups.
