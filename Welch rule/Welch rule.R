...
{    
    ...
    return(list=c(prop.reject=prop.reject,sims))
}
...
# large effect
reject.null.ve[,1,1] <- c(ve.ns20.bigd$classic.reject, ve.ns50.bigd$classic.reject, ve.ns100.bigd$classic.reject, ve.ns200.bigd$classic.reject)
reject.null.ve[,1,2] <- c(ve.ns20.bigd$welch.reject, ve.ns50.bigd$welch.reject, ve.ns100.bigd$welch.reject, ve.ns200.bigd$welch.reject)
...
coverage <- function(true.ihat, sims){
    ...
    classic.coverage <- (classic.ub-true.ihat)*(true.ihat-classic.lb)>0
    
    t.welch <- apply(welch.df, 1, function(x){qt(.025, df=x)})        
    welch.lb <- obs.ihat-t.welch*welch.ses
    welch.ub <- obs.ihat+t.welch*welch.ses
    welch.coverage <- (welch.ub-true.ihat)*(true.ihat-welch.lb)>0       

    classic.result <- prop.table(table(classic.coverage))[[2]]
    welch.result <- prop.table(table(welch.coverage))[[2]]
    result <- list(classic.result, welch.result)
    return(result)
}

## null true
cov.ns20.nullT.ve <- coverage(0,ve.ns20.nullT)
cov.ns50.nullT.ve <- coverage(0,ve.ns50.nullT)
cov.ns100.nullT.ve <- coverage(0,ve.ns100.nullT)
cov.ns200.nullT.ve <- coverage(0,ve.ns200.nullT)

## small effect
t.ihat.smalld.ve <- true.ihat(means=c(6,6.283), contrast=c(-1,1))
cov.ns20.smalld.ve <- coverage(t.ihat.smalld.ve,ve.ns20.smalld)
cov.ns50.smalld.ve <- coverage(t.ihat.smalld.ve,ve.ns50.smalld)
cov.ns100.smalld.ve <- coverage(t.ihat.smalld.ve,ve.ns100.smalld)
cov.ns200.smalld.ve <- coverage(t.ihat.smalld.ve,ve.ns200.smalld)

# medium effect
t.ihat.midd.ve <- true.ihat(means=c(6,6.707), contrast=c(-1,1))
cov.ns20.midd.ve <- coverage(t.ihat.midd.ve,ve.ns20.midd)
cov.ns50.midd.ve <- coverage(t.ihat.midd.ve,ve.ns50.midd)
cov.ns100.midd.ve <- coverage(t.ihat.midd.ve,ve.ns100.midd)
cov.ns200.midd.ve <- coverage(t.ihat.midd.ve,ve.ns200.midd)

# big effect
t.ihat.bigd.ve <- true.ihat(means=c(6,7.131), contrast=c(-1,1))
cov.ns20.bigd.ve <- coverage(t.ihat.bigd.ve,ve.ns20.bigd)
cov.ns50.bigd.ve <- coverage(t.ihat.bigd.ve,ve.ns50.bigd)
cov.ns100.bigd.ve <- coverage(t.ihat.bigd.ve,ve.ns100.bigd)
cov.ns200.bigd.ve <- coverage(t.ihat.bigd.ve,ve.ns200.bigd)
...
obs.coverage.ve[,1,1] <- c(cov.ns20.nullT.ve[[1]],cov.ns50.nullT.ve[[1]],cov.ns100.nullT.ve[[1]],cov.ns200.nullT.ve[[1]])
obs.coverage.ve[,2,1] <- c(cov.ns20.smalld.ve[[1]],cov.ns50.smalld.ve[[1]],cov.ns100.smalld.ve[[1]],cov.ns200.smalld.ve[[1]])
obs.coverage.ve[,3,1] <- c(cov.ns20.midd.ve[[1]],cov.ns50.midd.ve[[1]],cov.ns100.midd.ve[[1]],cov.ns200.midd.ve[[1]])
obs.coverage.ve[,4,1] <- c(cov.ns20.bigd.ve[[1]],cov.ns50.bigd.ve[[1]],cov.ns100.bigd.ve[[1]],cov.ns200.bigd.ve[[1]])
obs.coverage.ve[,1,2] <- c(cov.ns20.nullT.ve[[2]],cov.ns50.nullT.ve[[2]],cov.ns100.nullT.ve[[2]],cov.ns200.nullT.ve[[2]])
obs.coverage.ve[,2,2] <- c(cov.ns20.smalld.ve[[2]],cov.ns50.smalld.ve[[2]],cov.ns100.smalld.ve[[2]],cov.ns200.smalld.ve[[2]])
obs.coverage.ve[,3,2] <- c(cov.ns20.midd.ve[[2]],cov.ns50.midd.ve[[2]],cov.ns100.midd.ve[[2]],cov.ns200.midd.ve[[2]])
obs.coverage.ve[,4,2] <- c(cov.ns20.bigd.ve[[2]],cov.ns50.bigd.ve[[2]],cov.ns100.bigd.ve[[2]],cov.ns200.bigd.ve[[2]])
...
rownames(reject.null.v2) <- c("N=20", "N=50", "N=100", "N=200")
colnames(reject.null.v2) <- c("d=0", "d=.2", "d=.5", "d=.8")

# true null
reject.null.v2[1,1,1] <- prop.table(table(lapply(v2.ns20.nullT, '[[', 7)<=.05))[[2]]
reject.null.v2[2,1,1] <- prop.table(table(lapply(v2.ns50.nullT, '[[', 7)<=.05))[[2]]
reject.null.v2[3,1,1] <- prop.table(table(lapply(v2.ns100.nullT, '[[', 7)<=.05))[[2]]
reject.null.v2[4,1,1] <- prop.table(table(lapply(v2.ns200.nullT, '[[', 7)<=.05))[[2]]
reject.null.v2[1,1,2] <- prop.table(table(lapply(v2.ns20.nullT, '[[', 11)<=.05))[[2]]
reject.null.v2[2,1,2] <- prop.table(table(lapply(v2.ns50.nullT, '[[', 11)<=.05))[[2]]
reject.null.v2[3,1,2] <- prop.table(table(lapply(v2.ns100.nullT, '[[', 11)<=.05))[[2]]
reject.null.v2[4,1,2] <- prop.table(table(lapply(v2.ns200.nullT, '[[', 11)<=.05))[[2]]

# small effect
reject.null.v2[1,2,1] <- prop.table(table(lapply(v2.ns20.smalld, '[[', 7)<=.05))[[2]]
reject.null.v2[2,2,1] <- prop.table(table(lapply(v2.ns50.smalld, '[[', 7)<=.05))[[2]]
reject.null.v2[3,2,1] <- prop.table(table(lapply(v2.ns100.smalld, '[[', 7)<=.05))[[2]]
reject.null.v2[4,2,1] <- prop.table(table(lapply(v2.ns200.smalld, '[[', 7)<=.05))[[2]]
reject.null.v2[1,2,2] <- prop.table(table(lapply(v2.ns20.smalld, '[[', 11)<=.05))[[2]]
reject.null.v2[2,2,2] <- prop.table(table(lapply(v2.ns50.smalld, '[[', 11)<=.05))[[2]]
reject.null.v2[3,2,2] <- prop.table(table(lapply(v2.ns100.smalld, '[[', 11)<=.05))[[2]]
reject.null.v2[4,2,2] <- prop.table(table(lapply(v2.ns200.smalld, '[[', 11)<=.05))[[2]]

# medium effect
reject.null.v2[1,3,1] <- prop.table(table(lapply(v2.ns20.midd, '[[', 7)<=.05))[[2]]
reject.null.v2[2,3,1] <- prop.table(table(lapply(v2.ns50.midd, '[[', 7)<=.05))[[2]]
reject.null.v2[3,3,1] <- prop.table(table(lapply(v2.ns100.midd, '[[', 7)<=.05))[[2]]
reject.null.v2[4,3,1] <- prop.table(table(lapply(v2.ns200.midd, '[[', 7)<=.05))[[2]]
reject.null.v2[1,3,2] <- prop.table(table(lapply(v2.ns20.midd, '[[', 11)<=.05))[[2]]
reject.null.v2[2,3,2] <- prop.table(table(lapply(v2.ns50.midd, '[[', 11)<=.05))[[2]]
reject.null.v2[3,3,2] <- prop.table(table(lapply(v2.ns100.midd, '[[', 11)<=.05))[[2]]
reject.null.v2[4,3,2] <- prop.table(table(lapply(v2.ns200.midd, '[[', 11)<=.05))[[2]]

# large effect
reject.null.v2[1,4,1] <- prop.table(table(lapply(v2.ns20.bigd, '[[', 7)<=.05))[[2]]
reject.null.v2[2,4,1] <- prop.table(table(lapply(v2.ns50.bigd, '[[', 7)<=.05))[[2]]
reject.null.v2[3,4,1] <- prop.table(table(lapply(v2.ns100.bigd, '[[', 7)<=.05))[[2]]
reject.null.v2[4,4,1] <- 1 #prop.table(table(lapply(v2.ns200.bigd, '[[', 7)<=.05))[[2]]
reject.null.v2[1,4,2] <- prop.table(table(lapply(v2.ns20.bigd, '[[', 11)<=.05))[[2]]
reject.null.v2[2,4,2] <- prop.table(table(lapply(v2.ns50.bigd, '[[', 11)<=.05))[[2]]
reject.null.v2[3,4,2] <- prop.table(table(lapply(v2.ns100.bigd, '[[', 11)<=.05))[[2]]
reject.null.v2[4,4,2] <- 1 #prop.table(table(lapply(v2.ns200.bigd, '[[', 11)<=.05))[[2]]


##### 2 times different variances coverage rate #####

## null true
cov.ns20.nullT.v2 <- coverage(0,v2.ns20.nullT)
cov.ns50.nullT.v2 <- coverage(0,v2.ns50.nullT)
cov.ns100.nullT.v2 <- coverage(0,v2.ns100.nullT)
cov.ns200.nullT.v2 <- coverage(0,v2.ns200.nullT)

## small effect
t.ihat.smalld.v2 <- true.ihat(means=c(6,6.346), contrast=c(-1,1))
cov.ns20.smalld.v2 <- coverage(t.ihat.smalld.v2,v2.ns20.smalld)
cov.ns50.smalld.v2 <- coverage(t.ihat.smalld.v2,v2.ns50.smalld)
cov.ns100.smalld.v2 <- coverage(t.ihat.smalld.v2,v2.ns100.smalld)
cov.ns200.smalld.v2 <- coverage(t.ihat.smalld.v2,v2.ns200.smalld)

# medium effect
t.ihat.midd.v2 <- true.ihat(means=c(6,6.866), contrast=c(-1,1))
cov.ns20.midd.v2 <- coverage(t.ihat.midd.v2,v2.ns20.midd)
cov.ns50.midd.v2 <- coverage(t.ihat.midd.v2,v2.ns50.midd)
cov.ns100.midd.v2 <- coverage(t.ihat.midd.v2,v2.ns100.midd)
cov.ns200.midd.v2 <- coverage(t.ihat.midd.v2,v2.ns200.midd)

# big effect
t.ihat.bigd.v2 <- true.ihat(means=c(6,7.386), contrast=c(-1,1))
cov.ns20.bigd.v2 <- coverage(t.ihat.bigd.v2,v2.ns20.bigd)
cov.ns50.bigd.v2 <- coverage(t.ihat.bigd.v2,v2.ns50.bigd)
cov.ns100.bigd.v2 <- coverage(t.ihat.bigd.v2,v2.ns100.bigd)
cov.ns200.bigd.v2 <- coverage(t.ihat.bigd.v2,v2.ns200.bigd)


## store observed coverage rates
obs.coverage.v2 <- array(dim=c(4,4,2), dimnames=list(c("N=20", "N=50", "N=100", "N=200"), c("d=0", "d=.2", "d=.5", "d=.8"), c("classic", "welch")))

obs.coverage.v2[,1,1] <- c(cov.ns20.nullT.v2[[1]],cov.ns50.nullT.v2[[1]],cov.ns100.nullT.v2[[1]],cov.ns200.nullT.v2[[1]])
obs.coverage.v2[,2,1] <- c(cov.ns20.smalld.v2[[1]],cov.ns50.smalld.v2[[1]],cov.ns100.smalld.v2[[1]],cov.ns200.smalld.v2[[1]])
obs.coverage.v2[,3,1] <- c(cov.ns20.midd.v2[[1]],cov.ns50.midd.v2[[1]],cov.ns100.midd.v2[[1]],cov.ns200.midd.v2[[1]])
obs.coverage.v2[,4,1] <- c(cov.ns20.bigd.v2[[1]],cov.ns50.bigd.v2[[1]],cov.ns100.bigd.v2[[1]],cov.ns200.bigd.v2[[1]])
obs.coverage.v2[,1,2] <- c(cov.ns20.nullT.v2[[2]],cov.ns50.nullT.v2[[2]],cov.ns100.nullT.v2[[2]],cov.ns200.nullT.v2[[2]])
obs.coverage.v2[,2,2] <- c(cov.ns20.smalld.v2[[2]],cov.ns50.smalld.v2[[2]],cov.ns100.smalld.v2[[2]],cov.ns200.smalld.v2[[2]])
obs.coverage.v2[,3,2] <- c(cov.ns20.midd.v2[[2]],cov.ns50.midd.v2[[2]],cov.ns100.midd.v2[[2]],cov.ns200.midd.v2[[2]])
obs.coverage.v2[,4,2] <- c(cov.ns20.bigd.v2[[2]],cov.ns50.bigd.v2[[2]],cov.ns100.bigd.v2[[2]],cov.ns200.bigd.v2[[2]])
...
rownames(reject.null.v5) <- c("N=20", "N=50", "N=100", "N=200")
colnames(reject.null.v5) <- c("d=0", "d=.2", "d=.5", "d=.8")

# true null
reject.null.v5[1,1,1] <- prop.table(table(lapply(v5.ns20.nullT, '[[', 7)<=.05))[[2]]
reject.null.v5[2,1,1] <- prop.table(table(lapply(v5.ns50.nullT, '[[', 7)<=.05))[[2]]
reject.null.v5[3,1,1] <- prop.table(table(lapply(v5.ns100.nullT, '[[', 7)<=.05))[[2]]
reject.null.v5[4,1,1] <- prop.table(table(lapply(v5.ns200.nullT, '[[', 7)<=.05))[[2]]
reject.null.v5[1,1,2] <- prop.table(table(lapply(v5.ns20.nullT, '[[', 11)<=.05))[[2]]
reject.null.v5[2,1,2] <- prop.table(table(lapply(v5.ns50.nullT, '[[', 11)<=.05))[[2]]
reject.null.v5[3,1,2] <- prop.table(table(lapply(v5.ns100.nullT, '[[', 11)<=.05))[[2]]
reject.null.v5[4,1,2] <- prop.table(table(lapply(v5.ns200.nullT, '[[', 11)<=.05))[[2]]

# small effect
reject.null.v5[1,2,1] <- prop.table(table(lapply(v5.ns20.smalld, '[[', 7)<=.05))[[2]]
reject.null.v5[2,2,1] <- prop.table(table(lapply(v5.ns50.smalld, '[[', 7)<=.05))[[2]]
reject.null.v5[3,2,1] <- prop.table(table(lapply(v5.ns100.smalld, '[[', 7)<=.05))[[2]]
reject.null.v5[4,2,1] <- prop.table(table(lapply(v5.ns200.smalld, '[[', 7)<=.05))[[2]]
reject.null.v5[1,2,2] <- prop.table(table(lapply(v5.ns20.smalld, '[[', 11)<=.05))[[2]]
reject.null.v5[2,2,2] <- prop.table(table(lapply(v5.ns50.smalld, '[[', 11)<=.05))[[2]]
reject.null.v5[3,2,2] <- prop.table(table(lapply(v5.ns100.smalld, '[[', 11)<=.05))[[2]]
reject.null.v5[4,2,2] <- prop.table(table(lapply(v5.ns200.smalld, '[[', 11)<=.05))[[2]]

# medium effect
reject.null.v5[1,3,1] <- prop.table(table(lapply(v5.ns20.midd, '[[', 7)<=.05))[[2]]
reject.null.v5[2,3,1] <- prop.table(table(lapply(v5.ns50.midd, '[[', 7)<=.05))[[2]]
reject.null.v5[3,3,1] <- prop.table(table(lapply(v5.ns100.midd, '[[', 7)<=.05))[[2]]
reject.null.v5[4,3,1] <- prop.table(table(lapply(v5.ns200.midd, '[[', 7)<=.05))[[2]]
reject.null.v5[1,3,2] <- prop.table(table(lapply(v5.ns20.midd, '[[', 11)<=.05))[[2]]
reject.null.v5[2,3,2] <- prop.table(table(lapply(v5.ns50.midd, '[[', 11)<=.05))[[2]]
reject.null.v5[3,3,2] <- prop.table(table(lapply(v5.ns100.midd, '[[', 11)<=.05))[[2]]
reject.null.v5[4,3,2] <- prop.table(table(lapply(v5.ns200.midd, '[[', 11)<=.05))[[2]]

# large effect
reject.null.v5[1,4,1] <- prop.table(table(lapply(v5.ns20.bigd, '[[', 7)<=.05))[[2]]
reject.null.v5[2,4,1] <- prop.table(table(lapply(v5.ns50.bigd, '[[', 7)<=.05))[[2]]
reject.null.v5[3,4,1] <- prop.table(table(lapply(v5.ns100.bigd, '[[', 7)<=.05))[[2]]
reject.null.v5[4,4,1] <- 1 #prop.table(table(lapply(v5.ns200.bigd, '[[', 7)<=.05))[[2]]
reject.null.v5[1,4,2] <- prop.table(table(lapply(v5.ns20.bigd, '[[', 11)<=.05))[[2]]
reject.null.v5[2,4,2] <- prop.table(table(lapply(v5.ns50.bigd, '[[', 11)<=.05))[[2]]
reject.null.v5[3,4,2] <- prop.table(table(lapply(v5.ns100.bigd, '[[', 11)<=.05))[[2]]
reject.null.v5[4,4,2] <- 1 #prop.table(table(lapply(v5.ns200.bigd, '[[', 11)<=.05))[[2]]


##### 5 times different variances coverage rate #####

## null true
cov.ns20.nullT.v5 <- coverage(0,v5.ns20.nullT)
cov.ns50.nullT.v5 <- coverage(0,v5.ns50.nullT)
cov.ns100.nullT.v5 <- coverage(0,v5.ns100.nullT)
cov.ns200.nullT.v5 <- coverage(0,v5.ns200.nullT)

## small effect
t.ihat.smalld.v5 <- true.ihat(means=c(6,6.490), contrast=c(-1,1))
cov.ns20.smalld.v5 <- coverage(t.ihat.smalld.v5,v5.ns20.smalld)
cov.ns50.smalld.v5 <- coverage(t.ihat.smalld.v5,v5.ns50.smalld)
cov.ns100.smalld.v5 <- coverage(t.ihat.smalld.v5,v5.ns100.smalld)
cov.ns200.smalld.v5 <- coverage(t.ihat.smalld.v5,v5.ns200.smalld)

# medium effect
t.ihat.midd.v5 <- true.ihat(means=c(6,7.225), contrast=c(-1,1))
cov.ns20.midd.v5 <- coverage(t.ihat.midd.v5,v5.ns20.midd)
cov.ns50.midd.v5 <- coverage(t.ihat.midd.v5,v5.ns50.midd)
cov.ns100.midd.v5 <- coverage(t.ihat.midd.v5,v5.ns100.midd)
cov.ns200.midd.v5 <- coverage(t.ihat.midd.v5,v5.ns200.midd)

# big effect
t.ihat.bigd.v5 <- true.ihat(means=c(6,7.960), contrast=c(-1,1))
cov.ns20.bigd.v5 <- coverage(t.ihat.bigd.v5,v5.ns20.bigd)
cov.ns50.bigd.v5 <- coverage(t.ihat.bigd.v5,v5.ns50.bigd)
cov.ns100.bigd.v5 <- coverage(t.ihat.bigd.v5,v5.ns100.bigd)
cov.ns200.bigd.v5 <- coverage(t.ihat.bigd.v5,v5.ns200.bigd)


## store observed coverage rates
obs.coverage.v5 <- array(dim=c(4,4,2), dimnames=list(c("N=20", "N=50", "N=100", "N=200"), c("d=0", "d=.2", "d=.5", "d=.8"), c("classic", "welch")))

obs.coverage.v5[,1,1] <- c(cov.ns20.nullT.v5[[1]],cov.ns50.nullT.v5[[1]],cov.ns100.nullT.v5[[1]],cov.ns200.nullT.v5[[1]])
obs.coverage.v5[,2,1] <- c(cov.ns20.smalld.v5[[1]],cov.ns50.smalld.v5[[1]],cov.ns100.smalld.v5[[1]],cov.ns200.smalld.v5[[1]])
obs.coverage.v5[,3,1] <- c(cov.ns20.midd.v5[[1]],cov.ns50.midd.v5[[1]],cov.ns100.midd.v5[[1]],cov.ns200.midd.v5[[1]])
obs.coverage.v5[,4,1] <- c(cov.ns20.bigd.v5[[1]],cov.ns50.bigd.v5[[1]],cov.ns100.bigd.v5[[1]],cov.ns200.bigd.v5[[1]])
obs.coverage.v5[,1,2] <- c(cov.ns20.nullT.v5[[2]],cov.ns50.nullT.v5[[2]],cov.ns100.nullT.v5[[2]],cov.ns200.nullT.v5[[2]])
obs.coverage.v5[,2,2] <- c(cov.ns20.smalld.v5[[2]],cov.ns50.smalld.v5[[2]],cov.ns100.smalld.v5[[2]],cov.ns200.smalld.v5[[2]])
obs.coverage.v5[,3,2] <- c(cov.ns20.midd.v5[[2]],cov.ns50.midd.v5[[2]],cov.ns100.midd.v5[[2]],cov.ns200.midd.v5[[2]])
obs.coverage.v5[,4,2] <- c(cov.ns20.bigd.v5[[2]],cov.ns50.bigd.v5[[2]],cov.ns100.bigd.v5[[2]],cov.ns200.bigd.v5[[2]])


##### Save tables from double variances simulations #####
save(obs.coverage.v5, reject.null.v5, file='/users/joshwondra/R-projects/Welch rule/v5Seed2184Tables.Rdata')
load('/users/joshwondra/R-projects/Welch rule/v5Seed2184Tables.Rdata')
...
# 1.5 variances, 5% different Ns
set.seed(2184)
v1.5.ns20n5p.nullT <- t.compare(nsims=10000, Ns=c(20,21), means=c(6,6), vars=c(2,3), contrast=c(-1,1))
v1.5.ns50n5p.nullT <- t.compare(nsims=10000, Ns=c(50,53), means=c(6,6), vars=c(2,3), contrast=c(-1,1))
v1.5.ns100n5p.nullT <- t.compare(nsims=10000, Ns=c(100,105), means=c(6,6), vars=c(2,3), contrast=c(-1,1))
v1.5.ns200n5p.nullT <- t.compare(nsims=10000, Ns=c(200,210), means=c(6,6), vars=c(2,3), contrast=c(-1,1))
