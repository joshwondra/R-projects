...
set.seed(2184)
ve.bplots <- c(list(ve.distributions), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=20)), y=c(rnorm(20,6,sqrt(2)),rnorm(20,7.13,sqrt(2))), geom='boxplot', colour=factor(rep(c(1,2), each=20)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=100)), y=c(rnorm(100,6,sqrt(2)),rnorm(100,7.13,sqrt(2))), geom='boxplot', colour=factor(rep(c(1,2), each=100)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}))
...
set.seed(2184)
ve.bplots <- c(list(ve.distributions), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=20)), y=c(rnorm(20,6,sqrt(2)),rnorm(20,7.13,sqrt(10))), geom='boxplot', colour=factor(rep(c(1,2), each=20)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=100)), y=c(rnorm(100,6,sqrt(2)),rnorm(100,7.13,sqrt(10))), geom='boxplot', colour=factor(rep(c(1,2), each=100)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}))
...
ggplot(data.frame(x=seq(2,10,.1)), aes(x)) +
    ...
    labs(y=bquote(frac('df'['Welch'],'df'['Student'])), x=bquote(frac('s'[1]^2,'s'[2]^2))) +
...
ggplot(data.frame(x=seq(2,10,.1)), aes(x)) + 
    ...
    scale_colour_manual(values=c('blue', 'red'), labels=c(bquote(frac('n'[1],'n'[2])~'= 2'), bquote(frac('n'[1],'n'[2])~'= '~frac(1,2)))) +
    labs(y=bquote(frac('df'['Welch'],'df'['Student'])), x=bquote(frac('s'[1]^2,'s'[2]^2))) +
    scale_x_continuous(breaks=c(2,4,6,8,10), labels=c(2,4,6,8,10)/2)
@
...
T1classic <- ggplot(type1.classic, aes(x=as.numeric(var.ratio), y=type1.rate, shape=Ns, color=Ns, ymin=0, ymax=.13)) + 
    ...
    xlab('Variance Ratio (var1/var2)') + ylab('Type I Error Rate')
...
smalld.classic.power <- ggplot(power.classic.smalld, aes(x=as.numeric(var.ratio), y=power, shape=Ns, color=Ns, ymin=0, ymax=1)) + 
    ...
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Small Effect') + ggtitle("Student's t Test")
...
smalld.classic.deviation <- ggplot(power.classic.smalld, aes(x=as.numeric(var.ratio), y=power.diff, shape=Ns, color=Ns, ymin=-.3, ymax=.3)) + 
    ...
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Deviation') + ggtitle("Student's t Test")
...
midd.classic.power <- ggplot(power.classic.midd, aes(x=as.numeric(var.ratio), y=power, shape=Ns, color=Ns, ymin=0, ymax=1)) + 
    ...
    scale_x_discrete(breaks=seq(-2:2), labels=c(.2,.5,1,2,5)) +
    scale_y_continuous(breaks=seq(from=0, to=1, by=.1)) +
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Medium Effect') #+ ggtitle("Student's t Test")
...
bigd.classic.power <- ggplot(power.classic.bigd, aes(x=as.numeric(var.ratio), y=power, shape=Ns, color=Ns, ymin=0, ymax=1)) + 
    ...
    scale_x_discrete(breaks=seq(-2:2), labels=c(.2,.5,1,2,5)) +
    scale_y_continuous(breaks=seq(from=0, to=1, by=.1)) +
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Large Effect') #+ ggtitle("Student's t Test")
...
smalld.welch.power <- ggplot(power.welch.smalld, aes(x=as.numeric(var.ratio), y=power, shape=Ns, color=Ns, ymin=0, ymax=1)) + 
    ...
    scale_x_discrete(breaks=seq(-2:2), labels=c(.2,.5,1,2,5)) +
    scale_y_continuous(breaks=seq(from=0, to=1, by=.1)) +
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Small Effect') + ggtitle("Welch's t Test")
...
smalld.welch.deviation <- ggplot(power.welch.smalld, aes(x=as.numeric(var.ratio), y=power.diff, shape=Ns, color=Ns, ymin=-.3, ymax=.3)) + 
    ...
    scale_x_discrete(breaks=seq(-2:2), labels=c(.2,.5,1,2,5)) +
    scale_y_continuous(breaks=seq(from=-.3, to=.3, length.out=7)) +
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Deviation') + ggtitle("Welch's t Test")
...
midd.welch.power <- ggplot(power.welch.midd, aes(x=as.numeric(var.ratio), y=power, shape=Ns, color=Ns, ymin=0, ymax=1)) + 
    ...
    scale_x_discrete(breaks=seq(-2:2), labels=c(.2,.5,1,2,5)) +
    scale_y_continuous(breaks=seq(from=0, to=1, by=.1)) +
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Medium Effect') #+ ggtitle("Welch's t Test")
...
bigd.welch.power <- ggplot(power.welch.bigd, aes(x=as.numeric(var.ratio), y=power, shape=Ns, color=Ns, ymin=0, ymax=1)) + 
    ...
    scale_x_discrete(breaks=seq(-2:2), labels=c(.2,.5,1,2,5)) +
    scale_y_continuous(breaks=seq(from=0, to=1, by=.1)) +
    xlab(bquote('s'[1]^2~'/'~'s'[2]^2)) + ylab('Large Effect') #+ ggtitle("Welch's t Test")
...
multiplot(smalld.classic.power, smalld.welch.power, midd.classic.power, midd.welch.power, bigd.classic.power, bigd.welch.power, layout=layout)
...
ggplot(data.frame(x,y,group), aes(y=y, x=x, fill=group)) + geom_line(aes(colour=group))
