...
set.seed(2184)
ve.bplots <- c(list(ve.distributions), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=10)), y=c(rnorm(10,6,sqrt(2)),rnorm(10,7.13,sqrt(2))), geom='boxplot', colour=factor(rep(c(1,2), each=10)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=100)), y=c(rnorm(100,6,sqrt(2)),rnorm(100,7.13,sqrt(2))), geom='boxplot', colour=factor(rep(c(1,2), each=100)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}))
...
set.seed(2184)
ve.bplots <- c(list(ve.distributions), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=10)), y=c(rnorm(10,6,sqrt(2)),rnorm(10,7.13,sqrt(10))), geom='boxplot', colour=factor(rep(c(1,2), each=10)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}), lapply(1:4, function(x){qplot(x=factor(rep(c(1,2), each=100)), y=c(rnorm(100,6,sqrt(2)),rnorm(100,7.13,sqrt(10))), geom='boxplot', colour=factor(rep(c(1,2), each=100)), xlab=NULL, ylab=NULL, ylim=c(-2.5,17.5)) + theme(legend.position='none')}))
