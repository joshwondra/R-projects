...
\begin{figure}
<<varEqualBoxplots, echo=FALSE, collapse=TRUE, fig=TRUE>>=
...
\begin{figure}
<< dfratiosDiffvars, echo=FALSE, fig=TRUE>>=
...
\begin{figure}
<<dfratiosDiffNratios, echo=FALSE, fig=TRUE>>=
...
\begin{figure}
<<dfratiosDiffvarsDiffNratios, echo=FALSE, fig=TRUE>>=
ggplot(data.frame(x=seq(2,10,.1)), aes(x)) + 
...
\begin{figure}    
<<type1classicplot, echo=FALSE, fig=TRUE>>=
T1classic
@
...
\begin{figure}
<<plotPowerDiff, echo=FALSE, fig=TRUE>>=
