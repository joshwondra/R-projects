...
## Save simulations
save(ve.ns20.1.5n.nullT,ve.ns50.1.5n.nullT,ve.ns100.1.5n.nullT,ve.ns20.1.5n.smalld,ve.ns50.1.5n.smalld,ve.ns100.1.5n.smalld,ve.ns20.1.5n.midd,ve.ns50.1.5n.midd,ve.ns100.1.5n.midd,ve.ns20.1.5n.bigd,ve.ns50.1.5n.bigd,ve.ns100.1.5n.bigd, file='/users/joshwondra/R-projects/Welch rule/veN15Seed2184.Rdata')
load('/users/joshwondra/R-projects/Welch rule/veN15Seed2184.Rdata')
...
## Save simulations
save(ve.ns20.2n.nullT,ve.ns50.2n.nullT,ve.ns100.2n.nullT,ve.ns20.2n.smalld,ve.ns50.2n.smalld,ve.ns100.2n.smalld,ve.ns20.2n.midd,ve.ns50.2n.midd,ve.ns100.2n.midd, ve.ns20.2n.bigd,ve.ns50.2n.bigd,ve.ns100.2n.bigd, file='/users/joshwondra/R-projects/Welch rule/veN2Seed2184.Rdata')
load('/users/joshwondra/R-projects/Welch rule/veN2Seed2184.Rdata')
...
## Save simulations
save(v5.ns20.1.5n.ssv.nullT,v5.ns50.1.5n.ssv.nullT,v5.ns100.1.5n.ssv.nullT,v5.ns20.1.5n.ssv.smalld,v5.ns50.1.5n.ssv.smalld,v5.ns100.1.5n.ssv.smalld,v5.ns20.1.5n.ssv.midd,v5.ns50.1.5n.ssv.midd,v5.ns100.1.5n.ssv.midd, v5.ns20.1.5n.ssv.bigd,v5.ns50.1.5n.ssv.bigd,v5.ns100.1.5n.ssv.bigd, file='/users/joshwondra/R-projects/Welch rule/v5N15ssvSeed2184.Rdata')
load('/users/joshwondra/R-projects/Welch rule/v5N15ssvSeed2184.Rdata')
...
# Save simulations
save(v5.ns20.2n.ssv.nullT,v5.ns50.2n.ssv.nullT,v5.ns100.2n.ssv.nullT,v5.ns20.2n.ssv.smalld,v5.ns50.2n.ssv.smalld,v5.ns100.2n.ssv.smalld,v5.ns20.2n.ssv.midd,v5.ns50.2n.ssv.midd,v5.ns100.2n.ssv.midd, v5.ns20.2n.ssv.bigd,v5.ns50.2n.ssv.bigd,v5.ns100.2n.ssv.bigd, file='/users/joshwondra/R-projects/Welch rule/v5N2ssvSeed2184.Rdata')
load('/users/joshwondra/R-projects/Welch rule/v5N2ssvSeed2184.Rdata')
...
# Save simulations
save(v5.ns20.2n.bsv.nullT,v5.ns50.2n.bsv.nullT,v5.ns100.2n.bsv.nullT,v5.ns20.2n.bsv.smalld,v5.ns50.2n.bsv.smalld,v5.ns100.2n.bsv.smalld,v5.ns20.2n.bsv.midd,v5.ns50.2n.bsv.midd,v5.ns100.2n.bsv.midd, v5.ns20.2n.bsv.bigd,v5.ns50.2n.bsv.bigd,v5.ns100.2n.bsv.bigd, file='/users/joshwondra/R-projects/Welch rule/v5N2bsvSeed2184.Rdata')
load('/users/joshwondra/R-projects/Welch rule/v5N2bsvSeed2184.Rdata')
...
dfs.list <- list(
    ve.ns20.ne.nullT=unlist(lapply(ve.ns20.ne.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    ve.ns50.ne.nullT=unlist(lapply(ve.ns50.ne.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    ve.ns100.ne.nullT=unlist(lapply(ve.ns100.ne.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v2.ns50.ne.nullT=unlist(lapply(v2.ns50.ne.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v5.ns50.ne.nullT=unlist(lapply(v5.ns50.ne.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    ve.ns50.1.5n.nullT=unlist(lapply(ve.ns50.1.5n.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    ve.ns50.2n.nullT=unlist(lapply(ve.ns50.2n.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v2.ns50.1.5n.ssv.nullT=unlist(lapply(v2.ns50.1.5n.ssv.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v2.ns50.2n.ssv.nullT=unlist(lapply(v2.ns50.2n.ssv.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v5.ns50.1.5n.ssv.nullT=unlist(lapply(v5.ns50.1.5n.ssv.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v5.ns50.2n.ssv.nullT=unlist(lapply(v5.ns50.2n.ssv.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v2.ns50.1.5n.bsv.nullT=unlist(lapply(v2.ns50.1.5n.bsv.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v2.ns50.2n.bsv.nullT=unlist(lapply(v2.ns50.2n.bsv.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v5.ns50.1.5n.bsv.nullT=unlist(lapply(v5.ns50.1.5n.bsv.nullT$sims, function(x){x$df.welch/x$df.classic})), 
    v5.ns50.2n.bsv.nullT=unlist(lapply(v5.ns50.2n.bsv.nullT$sims, function(x){x$df.welch/x$df.classic})))
